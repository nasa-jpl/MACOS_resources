...
plus the repo.  Genre: WORKBOOK (DECK2_PLAN.md) -- ~17 content slides in
...
continuation walk, parsed from t5r_REPORT.md / t5_walk_REPORT.md via
rodgers3_records.parse_walk), F17 the discussion.
...
~ THE METRIC CONTRACT, once for the whole deck: {TAG}.  Every WFE number on every slide inherits it.  Workbook genre: 17 content slides in six sections (budget deviation declared, DECK2_PLAN.md).  DRAFT — pending sign-off.
...
MD = MD.replace("(walk_layout)", f"({TWREL}/t5_walk_k05_layout.png)")
