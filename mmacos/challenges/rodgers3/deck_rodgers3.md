...
- And the lessons COMPILE: the continuation runner distilled from this arc (oi_walk — solve an easy field box, then walk it open with warm starts) lands a fresh, harder instance at 69.8 nm unattended, 8531x better than its cold start (the full experiment: companion deck, section F).
::: right
