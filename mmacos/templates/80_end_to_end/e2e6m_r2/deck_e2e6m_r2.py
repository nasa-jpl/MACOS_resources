...
- **The families (dark-zone mean, PRE-CONTROL | throughput):** classical Lyot {cf1['fam']['hard']['mean']:.2e} pre-control, {cf1['fam']['hard']['thru_pct']:.0f}% throughput; apodized Lyot {cf1['fam']['apl']['mean']:.2e} pre-control, {cf1['fam']['apl']['thru_pct']:.0f}% throughput; APLC-as-implemented {cf1['fam']['aplc']['mean']:.2e} pre-control, {cf1['fam']['aplc']['thru_pct']:.0f}% throughput (cap-limited prolate, not design-grade on this pupil; family DEFERRED); band-limited {cf1['fam']['blc']['mean']:.2e} pre-control, {cf1['fam']['blc']['thru_pct']:.0f}% throughput; vortex c4 {cf1['fam']['v4']['mean']:.2e} pre-control, {cf1['fam']['v4']['thru_pct']:.0f}% throughput; c6 {cf1['fam']['v6']['mean']:.2e} pre-control, {cf1['fam']['v6']['thru_pct']:.0f}% throughput -- the vortex passes the segment-gap light the occulting families block.
...
::: left
- **static -> relin floor | linear-achievable at the achieved stroke:** classical Lyot {cf2['fam']['hard']['static']:.1e} -> {cf2['fam']['hard']['relin']:.1e} | {cf2['fam']['hard']['linach']:.1e}; apodized Lyot {cf2['fam']['apl']['static']:.1e} -> {cf2['fam']['apl']['relin']:.1e} | {cf2['fam']['apl']['linach']:.1e} (the campaign floor); APLC-as-implemented {cf2['fam']['aplc']['static']:.1e} -> {cf2['fam']['aplc']['relin']:.1e} | {cf2['fam']['aplc']['linach']:.1e} (implementation verdict, not family); band-limited {cf2['fam']['blc']['static']:.1e} -> {cf2['fam']['blc']['relin']:.1e} | {cf2['fam']['blc']['linach']:.1e}; vortex c4 {cf2['fam']['v4']['static']:.1e} -> {cf2['fam']['v4']['relin']:.1e} | {cf2['fam']['v4']['linach']:.1e}; c6 {cf2['fam']['v6']['static']:.1e} -> {cf2['fam']['v6']['relin']:.1e} | {cf2['fam']['v6']['linach']:.1e}.
