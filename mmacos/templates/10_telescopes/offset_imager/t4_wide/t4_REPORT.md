...
2026-08-19 20:48:00.  EPD 200 mm, F/2.5 (EFL 0.500 m held as an identity), lambda 1.00 um, box 10x10° offset +12°, spacings [-0.1 0 1.1] m, model 256, nGridpts 41.
...
| exit chief | -175.258° in Y-Z (report-only; no pin) |
...
| exit chief | -175.250° in Y-Z (report-only; no pin) |
| clearance floor | 2.0 mm (FAIL; gate >= 35 mm; WARN < 50 mm) |
